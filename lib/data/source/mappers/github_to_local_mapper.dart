import 'package:pokedex_demo/core/extensions/string.dart';
import 'package:pokedex_demo/data/source/github/models/item.dart';

import 'package:pokedex_demo/data/source/github/models/pokemon.dart';
import 'package:pokedex_demo/data/source/local/models/item.dart';

import 'package:pokedex_demo/data/source/local/models/pokemon.dart';
import 'package:pokedex_demo/data/source/local/models/pokemon_gender.dart';
import 'package:pokedex_demo/data/source/local/models/pokemon_stats.dart';
...
extension GithubPokemonModelToLocalX on GithubPokemonModel {
  PokemonHiveModel toHiveModel() => PokemonHiveModel()
    ...
    ..eggGroups =
        eggGroups?.split(RegExp(r',\s*?')).map((e) => e.trim()).toList() ?? []
